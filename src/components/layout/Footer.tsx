    ...
    <footer className="bg-slate-900 text-white">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-4">
            <Link href="/" className="flex items-center gap-2">
              ...
              <span className="font-bold text-xl">
                Rankers <span className="text-indigo-400">Forum</span>
              </span>
            </Link>
            <p className="text-slate-400 text-sm">
              Your trusted partner for NEET college admissions guidance. Get personalized predictions based on your rank.
            </p>
          ...
          <div id="contact">
            ...
            <ul className="space-y-3 text-sm">
              ...
              <li className="flex items-center gap-2 text-slate-400">
                ...
                <span>support@rankersforum.com</span>
              </li>
        ...
        <div className="py-6 border-t border-slate-800 text-center text-sm text-slate-400">
          <p>© {currentYear} Rankers Forum. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
