...
export function Hero({ onCheckColleges }: HeroProps) {
    return (
        <section className="relative pt-24 lg:pt-32 
         md:h-[980px] lg:h-screen h-screen overflow-hidden">
                ...
                <div className="relative  h-full ">
                    ...
                    <div className="text-center max-w-4xl mx-auto space-y-4 relative z-10">
                        ...
                        <div className="absolute top-80 lg:-top-4 right-0    lg:-right-48  bot lg:block animate-float">
                            ...
                            <div className="flex  gap-2 px-4  py-3  bg-[#3A7BF00A] 
                            rounded-lg rounded-2xl shadow-lg border border-[#3B82F6]/20">
                        ...
                        {/* Description */}
                        <p className="text-sm md:text-base sm:text-lg text-[#4B5563]
                        font-medium max-w-5xl mx-auto leading-relaxed">
                        ...
                        <div className=" mt-7 md:mt-12">
                            <Button
                                size="lg"
                                className="text-base h-14 px-8 font-normal
                                bg-linear-to-r from-[#2F129B] to-[#3B82F6] text-white rounded-full 
                    ...
                    <div className="absolute left-5 md:left-32 lg:left-66 top-78  lg:block
                     animate-float-delayed lg:w-32 lg:h-32 md:w-24 md:h-24 w-12 h-12  rounded-[16px]  overflow-hidden   ">
                    ...
                    <div className="absolute left-10 md:left-0 lg:left-10 top-108 md:top-auto bottom-80 lg:top-44  lg:block animate-float">
                        <div className="flex items-start gap-2 px-4 py-4 bg-[#3A7BF00A] rounded-lg
