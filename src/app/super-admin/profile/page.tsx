...
export default function ProfilePage() {
  ...
  return (
    <AdminLayout title="My Profile">
      {/* Profile Header */}
      <div className="bg-white rounded-xl border border-slate-100 p-8 mb-8">
      ...
      <div className="bg-white rounded-xl border border-slate-100 p-8 mb-8">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          ...
          <div>
            ...
            <p className="font-medium text-slate-900">{profile.phone ? `+91 ${profile.phone}` : '-'}</p>
          </div>
          <div>
          ...
          <div>
            ...
            <p className="font-medium text-slate-900 capitalize">{profile.maritalStatus || '-'}</p>
          </div>
          <div>
          ...
          <div>
            ...
            <p className="font-medium text-slate-900">{profile.nationality || 'India'}</p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white rounded-xl border border-slate-100 p-8">
        <h3 className="text-lg font-semibold text-indigo-700 mb-6">Job Details</h3>

        <div className="grid md:grid-cols-3 gap-6">
          <div>
            <p className="text-sm text-slate-500">Employee Number</p>
            <p className="font-medium text-slate-900">{profile.employeeNumber || '-'}</p>
          </div>
          <div>
            <p className="text-sm text-slate-500">Date of Joining</p>
            <p className="font-medium text-slate-900">{profile.dateOfJoining || '-'}</p>
          </div>
          <div>
          ...
          <div>
            ...
            <p className="font-medium text-slate-900">{profile.noticePeriod || '1 Month'}</p>
          </div>
        </div>
      </div>
    </AdminLayout>
